...
int main(int argc, char **argv) {
    ...
    has_datum = true;
    has_datum &= n->getParam("/xbot_driver_gps/datum_lat", datum_lat);
    has_datum &= n->getParam("/xbot_driver_gps/datum_long", datum_long);
    has_datum &= n->getParam("/xbot_driver_gps/datum_height", datum_height);
